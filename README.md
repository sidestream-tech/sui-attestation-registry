...
- [attestation_type_example](./attestation_type_example/) – Sui/Move package that implements example type by integrating `attestation` package
- [attestation_pinning_example](./attestation_pinning_example/) – Sui/Move package that implements basic package to claim its Publisher and pin relevant attestation
